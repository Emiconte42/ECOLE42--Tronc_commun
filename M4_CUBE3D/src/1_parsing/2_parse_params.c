...
/*   Updated: 2026/07/17 15:40:50 by emiconte         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_check_missing_elements(t_game *game)
{
	...
	if (ft_check_duplicate_textures(game) == 0)
		return (0);
	if (ft_check_duplicate_colors(game) == 0)
		return (0);
